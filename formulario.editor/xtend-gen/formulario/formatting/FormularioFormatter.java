...
public class FormularioFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private FormularioGrammarAccess _formularioGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._formularioGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._formularioGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._formularioGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._formularioGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._formularioGrammarAccess.getML_COMMENTRule();
